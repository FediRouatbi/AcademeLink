...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser: { __typename?: 'CurrentUser', email: string, createdAt: any, first_name: string, last_name: string, role: RoleCodeEnum, updatedAt: any, user_id: number, user_name: string } };
